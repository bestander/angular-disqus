(function (angular, window) {
    ...
    disqusModule.provider('$disqus', function() {
         ...
         * @param  {String} title thread title
         */
        function buildCommit($location, id, disqusSsoCredentials, title) {
            ...
            setGlobals(id, $location.absUrl(), shortname, disqusSsoCredentials, title);
        ...
        this.$get = [ '$location', '$disqusSsoConfig', function($location, $disqusSsoConfig) {
            ...
            function commit(id, title) {
                if (!angular.isDefined(getShortname())) {
                    ...
                    buildCommit($location, id, $disqusSsoConfig.getCredentials(), title);
                }
            }
